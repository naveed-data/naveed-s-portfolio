...
export function Hero({ onNavigate }: { onNavigate: (key: SectionKey) => void }) {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative flex min-h-[calc(100dvh-4rem)] flex-col items-center justify-center overflow-hidden px-6 py-4 sm:py-6"
    >
      <motion.div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center gap-10 lg:flex-row lg:justify-center lg:gap-16">
        ...
        >
          <div ref={panelRef} style={{ transition: "transform 300ms ease-out" }} className="group relative">
            <div className="relative overflow-hidden rounded-[32px] border border-white/30 bg-white/60 p-7 text-center shadow-[0_1px_0_0_rgba(255,255,255,0.4)_inset,0_8px_40px_-8px_rgba(139,92,246,0.25),0_30px_80px_-20px_rgba(0,0,0,0.25)] backdrop-blur-2xl transition-shadow duration-500 hover:shadow-[0_1px_0_0_rgba(255,255,255,0.5)_inset,0_8px_60px_-4px_rgba(139,92,246,0.4),0_40px_100px_-20px_rgba(0,0,0,0.3)] dark:border-white/10 dark:bg-zinc-950/50 sm:p-8">
              <div
                aria-hidden
              ...
              <motion.p
                className="mt-3 min-h-[1.75rem] text-lg font-semibold text-zinc-700/90 dark:text-zinc-300/90 sm:text-xl"
              ...
              <motion.p
                className="animate-float-tiny mt-1 flex flex-wrap justify-center text-sm font-medium text-violet-600 drop-shadow-[0_0_14px_rgba(139,92,246,0.5)] dark:text-violet-400"
                initial="hidden"
                animate="visible"
                variants={{
                  hidden: {},
              ...
              <motion.p
                className="mx-auto mt-3 max-w-md text-base leading-6 text-zinc-600 dark:text-zinc-400"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <motion.button
                  ...
                  className="btn-gradient-nova relative isolate overflow-hidden rounded-full px-7 py-3 text-sm font-semibold text-white shadow-[0_0_30px_rgba(139,92,246,0.5)] transition-shadow duration-300 hover:shadow-[0_0_50px_rgba(139,92,246,0.75)]"
                >
                  <span
                    aria-hidden
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  transition={{ type: "spring", stiffness: 400, damping: 22 }}
                  className="relative isolate overflow-hidden rounded-full border border-white/30 bg-white/10 px-6 py-3 text-sm font-semibold text-zinc-700 backdrop-blur-md transition-colors hover:bg-white/20 dark:border-white/10 dark:bg-white/5 dark:text-zinc-200 dark:hover:bg-white/10"
                >
                  Explore Projects
                </motion.button>
              </motion.div>
